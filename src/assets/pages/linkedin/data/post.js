export const POSTS = [
  {
    ...
    logoAlt: "Andrés Rivera Valle Logo",
    userName: "Andrés Rivera Valle",
    userFollowers: "735 seguidores",
    postTime: "1 hora",
    postDescription:
      "🚀 We took off with the first repliverse website! Inspired by the genius of Conikal and his original design for Deupload, I brought the main landing page to life based on his artwork and I can't wait to share future projects! Take the challenge to layout it with HTML, CSS and JS web base to improve my skills in these languages. 🎨",
  ...
  },
  {
    ...
    postTime: "3 horas",
    postDescription:
      "Ever wonder how companies keep their designs consistent? It’s all thanks to design systems and style guides... but what's the difference?",
